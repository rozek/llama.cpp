...
int main(int argc, char ** argv) {
    ...
    if (params.n_ctx > 4096) {
        // TODO: determine the actual max context of the model (e.g. 4096 for LLaMA v2) and use that instead of 4096
        fprintf(stderr, "%s: warning: base model only supports context sizes no greater than 4096 tokens (%d specified)\n", __func__, params.n_ctx);
