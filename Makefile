...
BUILD_TARGETS = main quantize quantize-stats perplexity embedding tokencount tokenization vdot train-text-from-scratch convert-llama2c-to-ggml simple server embd-input-test gguf llama-bench
